          ...
          <Container disableGutters>
            ...
            <Grid container justify="space-around" alignItems="flex-start">
              <Grid item sm={12} lg={6} md={6}>
                ...
                <Button variant="contained" size="large" className="btn1" component={Link} to="/signup">
                  Try for free
                </Button>
            ...
            <Grid container alignItems="flex-start" justify="space-between">
              ...
              <Grid item md={6} sm={12} lg={6}>
                ...
                <Button variant="contained" size="large" className="btn1" component={Link} to="/tryout">
                ...
                >
                  ...
                  <Grid item md={9}>
                    <Typography>
                      ...
                      adipisicing elit. Eum, corrupti eveniet facere et impedit
                      nostrum ipsam molestias corrupti eveniet facere et impedit
                      nostrum ipsam molestias
                    </Typography>
                  </Grid>
                </Grid>
                <Grid
                  ...
                  <Card variant="outlined">
                    <CardContent>
                      ...
                      <Typography className="f_description">
                        ...
                        perspiciatis atque modi totam animi ad, quos aliquam
                        quia impedit vero unde sapiente aperiam?
                      </Typography>
                    </CardContent>
                  </Card>
                </Grid>
